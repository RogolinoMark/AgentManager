...
class Functions:
    ...
    def __init__(self, mode, session_mode):
        self.mode = mode
        self.session_mode = session_mode
        self.storage = StorageInterface(restore_previous_state=self.session_mode)
    ...
    def check_auto_mode(self, feedback_from_status=None, feedbackmode="n"):
        context = None
